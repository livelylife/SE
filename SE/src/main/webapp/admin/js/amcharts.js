...
(function () {
    ...
    d.AxisBase = d.Class({
        ...
        addEventListeners: function (a, b) {
            ...
            var u, y = this.gridAlpha, x, w = this.choosePeriod(0), B = w.period, w = w.count,
            ...
            if (0 < this.gridCountR) for (A - 5 - k >
            ...
            b && (b = b.cursorPosition, "mouse" != b && (this.stickBalloonToCategory =
                !0), "start" == b && (this.stickBalloonToStart = !0), "ValueAxis" == this.cname && (this.stickBalloonToCategory = !1));
    ...
    d.ValueAxis = d.Class({
        inherits: d.AxisBase, construct: function (a) {
            ...
            if (isNaN(this.min) || isNaN(this.max) || !this.foundGraphs || Infinity == this.min || -Infinity == this.max) e = !0; else {
                ...
                if (this.autoGridCount || 0 !== this.gridCount) if ("date" == c) this.generateDFObject(), this.timeDifference = this.max - this.min, this.maxTime = this.lastTime = this.max, this.startTime = this.firstTime = this.min, this.parseDatesDraw(); else for (t >= this.autoRotateCount && !isNaN(this.autoRotateAngle) && (this.labelRotationR =
                    this.autoRotateAngle), h && t++, g = f; g < t; g += p) if (c = y * g + this.minCalc, c = d.roundTo(c, this.maxDecCount + 1), !this.integersOnly || Math.round(c) == c) if (isNaN(r) || Number(d.toFixed(c, r)) == c) {
            ...
            var d = this.fullMax, e = this.fullMin;
            ...
            if (this.minZoom != a || this.maxZoom != b) return this.minZoom =
                a, this.maxZoom = b, c || (c = {type: "axisZoomed"}, c.chart = this.chart, c.valueAxis = this, c.startValue = a, c.endValue = b, c.relativeStart = this.relativeStart, c.relativeEnd = this.relativeEnd, this.fire(c)), !0
...
(function () {
    ...
    d.RecItem = d.Class({
        construct: function (a, b, c, e, h, f, g, k, l, m, n, q) {
            ...
            this.set = x;
            var w = a.axisThickness, B = a.axisColor, z = a.axisAlpha, A = a.tickLength, C = a.gridAlpha,
                D = a.gridThickness, J = a.gridColor, H = a.dashLength, R = a.fillColor, L = a.fillAlpha,
                P = a.labelsEnabled;
            n = a.labelRotationR;
            var ia = a.counter, I = a.inside, Z = a.labelOffset, va = a.dx, la = a.dy, Oa = a.orientation,
...
(function () {
    ...
    d.AmChart = d.Class({
        construct: function (a) {
            ...
            a =
                {x: a, y: b, text: c, align: e, size: d, color: f, alpha: k, rotation: g, bold: l, url: m, enabled: !0};
            ...
            if (this.animations) for (a = this.animations.length - 1; 0 <= a; a--) {
                ...
                if (e <= c) {
                    b.frame++;
                    var g = Number(b.from),
                        k = Number(b.to) - g, c = d[b.effect](0, e, g, k, c);
    ...
    d.AmGraph = d.Class({
        construct: function (a) {
                ...
                if (isNaN(q)) this.connect || (this.drawLineGraph(b, c, e, d), b = [], c = [], e = [], d = []); else {
                    ...
                    if (!isNaN(p)) {
                        var u = this.valueAxis.getCoordinate(p, this.noRounding) - this.height,
                            u = u * this.valueAxis.rMultiplier, y = u * Math.sin(r / 180 * Math.PI),
            ...
            var m = this.useNegativeColorIfDown, n = this.width, q = this.height, p = this.y, t = this.rotate,
                r = this.columnCount, u = d.toCoordinate(this.cornerRadiusTop, k / 2), y = this.connect, x = [], w = [],
                B, z, A, C, D =
                    this.chart.graphs.length, J, H = this.dx / this.tcc, R = this.dy / this.tcc, L = f.stackType,
                P = this.start, ia = this.end, I = this.scrollbar, Z = "graph-column-";
            I && (Z = "scrollbar-graph-column-");
            var va = this.categoryAxis, la = this.baseCoord, Oa = this.negativeBase, ea = this.columnIndex,
            ...
            T > Ca && (T = Ca);
            var G, v, ma, ha = q, Pa = n, ba = 0, tb = 0, ub, vb, gb, hb, wb = this.fillColorsR,
            ...
            if (!(I || "line" != g && "smoothedLine" != g && "step" != g || (1 == e.length && "step" != g && "none" == this.bullet && (this.bullet = "round", this.resetBullet = !0), !Qa && void 0 == Ja || m))) {
                ...
                var Ka = f.getCoordinate(Ua), Nb = f.getCoordinate(f.max);
            ...
            if ("line" == g || "step" == g || "smoothedLine" == g) {
                if (0 < P) {
                    ...
                    if (this.fillColorsField) for (M = P; -1 < M; M--) if (G = e[M], v = G.axes[f.id].graphs[b],
                        v.fillColors) {
            ...
            var Pb = this.noStepRisers, jb = -1E3,
                kb = -1E3, lb = this.minDistance, Sa = !0, $a = !1, yb = 0, zb = 0;
            for (M = P; M <= ia; M++) {
                G = e[M];
                ...
                var S, Q, K, aa, na = NaN, E = NaN, F = NaN, O = NaN, N = NaN, pa = NaN, qa = NaN, ra = NaN, sa = NaN,
                    wa = NaN, Da = NaN, ja = NaN, ka = NaN, W = NaN, Bb = NaN, Cb = NaN, ta = NaN, ua = void 0, Ma = wb,
                    Va = Ya, Ha = ya, Aa, Ea, Db = this.proCandlesticks, mb = this.topRadius, Fa = q - 1, oa = n - 1,
                    bb = this.pattern;
                ...
                if (Ia) {
                    ...
                    var na = G.x[va.id], Wa = this.periodSpan - 1;
                    ...
                    switch (g) {
                        case "line":
                            if (isNaN(W)) y || (this.drawLineGraph(x, w, U, V), x = [], w = [], U = [], V = []); else {
                            ...
                            break;
                        case "smoothedLine":
                            if (isNaN(W)) y || (this.drawSmoothedGraph(x, w, U, V), x = [], w = [], U = [], V = []); else {
                        ...
                        case "step":
                            if (!isNaN(W)) {
                                ...
                                if ($a || void 0 != v.lineColor || void 0 != v.fillColors || !isNaN(v.dashLength)) {
                                    var ec = x[x.length - 2], fc = w[w.length - 2];
                                    x.pop();
                                    w.pop();
                        ...
                        case "ohlc":
                            if (!(isNaN(ta) || isNaN(Bb) || isNaN(Cb) || isNaN(W))) {
                                ...
                                if (t) {
                                    ...
                                    if (0 === E && 0 === O && 0 === pa && 0 === ra) continue;
                                    if (E == oa && O == oa && pa == oa && ra == oa) continue;
                                    var Jb = F - k / 2, Jb = d.fitToBounds(Jb, 0, q), Ub = d.fitToBounds(F, 0, q),
                                        Kb = F + k / 2, Kb = d.fitToBounds(Kb, 0, q);
                                    ...
                                    "high" == l && (ka = sa);
                                    "low" == l && (ka = qa);
                                    var ja = E, qa = d.fitToBounds(qa, 0, Fa), sa = d.fitToBounds(sa, 0, Fa),
                                        Lb = E - k / 2, Lb = d.fitToBounds(Lb, 0, n), Vb = d.fitToBounds(E, 0, n),
                                        Mb = E + k / 2, Mb = d.fitToBounds(Mb, 0, n);
                    ...
                    if (!I && !isNaN(W)) {
                        ...
                        if (this.end - this.start <= Wb || 0 === Wb) {
                            var Xb = this.createBullet(v, ja, ka, M), Yb = this.labelText;
                            if (Yb && !isNaN(wa) && !isNaN(wa)) {
                                var ic = this.createLabel(v, Yb), Zb = 0;
                                Xb && (Zb = Xb.size);
                            ...
                            if ("regular" == L || "100%" == L) {
                                ...
                                if ($b) {
                                    ...
                                    if (Na) {
                                        var ac = Na.getBBox(), bc = ac.width,
                                            cc = ac.height, db, eb, sb = f.totalTextOffset, dc = f.totals[M];
                                        dc && dc.remove();
                                        var fb = 0;
            ...
            if (1 < a.length) {
                ...
                g.push(m);
                var q =
                    h.lineAlpha, p = h.lineThickness, g = h.fillAlphas, t = h.lineColorR, r = h.negativeLineAlpha;
                isNaN(r) && (r = q);
                var u = h.lineColorSwitched;
                u && (t = u);
                var u = h.fillColorsR, y = h.fillColorsSwitched;
                y && (u = y);
                var x = h.dashLength;
                (y = h.dashLengthSwitched) && (x = y);
                var y = h.negativeLineColor, w = h.negativeFillColors, B = h.negativeFillAlphas, z = h.baseCoord;
                ...
                if (0 < g || 0 < B) if (p = a.join(";").split(";"), r = b.join(";").split(";"), q = k.type, "serial" == q || "radar" == q ? 0 < c.length ? (c.reverse(),
            ...
            if (1 < a.length) {
                ...
                var m = this.lineAlpha, n = this.lineThickness, h = this.dashLength, q = this.fillAlphas,
                    p = this.lineColorR,
                    t = this.fillColorsR, r = this.negativeLineColor, u = this.negativeFillColors,
                    y = this.negativeFillAlphas, x = this.baseCoord, w = this.lineColorSwitched;
                w && (p = w);
            ...
            if (!isNaN(b) && !isNaN(c) && ("none" != this.bullet || this.customBullet || a.bullet || a.customBullet)) {
                ...
                var k = a.values.value,
                    l = this.maxValue, m = this.minValue, n = this.maxBulletSize, q = this.minBulletSize;
...
(function () {
    ...
    d.ChartCursor = d.Class({
        construct: function (a) {
            ...
            this.update();
            if (this.mouseIsOver()) if (this.mouseIsDown =
...
(function () {
    ...
    d.SimpleChartScrollbar = d.Class({
        construct: function (a) {
            ...
            var a, b =
                !1, c, e, d = this.x, f = this.y, g = this.dragger, k = this.getDBox();
            if (k) {
                c = k.x + d;
                e = k.y + f;
            ...
            var b = this.getDBox();
            if (b) {
                var c = b.x, d = b.y, h = b.width, b = b.height, f = !1;
                if (this.rotate) {
        ...
        handleBgClick: function () {
            ...
            if (!a.resizingRight && !a.resizingLeft) {
                ...
                a.updateOnReleaseOnly ? (a.skipEvent = !1, h.setAttr(b, c), a.dispatchScrollbarEvent(), a.clipDragger()) : (a.animating = !0, c = Math.round(c), m ? h.animate({y: c}, e, ">") : h.animate({x: c}, e, ">"), a.forceClip =
    ...
    d.ChartScrollbar = d.Class({
        inherits: d.SimpleChartScrollbar, construct: function (a) {
            ...
            if ("ValueAxis" == this.categoryAxis.cname) d.ChartScrollbar.base.dispatchScrollbarEvent.call(this); else if (this.skipEvent) this.skipEvent = !1; else {
                ...
                f.chart = g;
                var k = this.categoryAxis, l = this.stepWidth, h = g.minSelectedTime, e = !1;
        ...
        construct: function (a) {
            ...
            if (!isNaN(a)) {
                ...
                if (this.show) {
                    ...
                    var r = this.horizontalPadding, u = this.verticalPadding, y = this.pointerWidth,
                        x = this.pointerOrientation, w = this.cornerRadius,
                        B = c.fontFamily, z = this.fontSize;
                    void 0 == z && (z = c.fontSize);
                    var n = document.createElement("div"), A = c.classNamePrefix;
                    ...
                    C < g && (C = g);
                    C + D > l && (C = l - D);
                    var k = z + u, m = C + r, L = this.shadowAlpha, P = this.shadowColor, r = this.borderThickness,
                    ...
                    0 < this.animationDuration && !e && !isNaN(this.prevX) && (f.translate(this.prevX, this.prevY, NaN, !0), f.animate({translate: C - h + "," + z}, b, "easeOutSine"), n && (A.left = this.prevTX + "px", A.top = this.prevTY + "px", this.xAnim = c.animate({node: n}, "left", this.prevTX, m, b, "easeOutSine",
...
(function () {
    ...
    d.AmCoordinateChart = d.Class({
        inherits: d.AmChart, construct: function (a) {
            ...
            this.colors = "#ea4c89 #00C6D7 #052963 #0D8ECF #2A0CD0 #CD0D74 #021f4e #ea4c89 #ea4c89 #DDDDDD #999999 #333333 #990000".split(" ");
    ...
    d.TrendLine = d.Class({
        construct: function (a) {
            ...
            var b = a.chart, c = b.container, e, h, f, g, k = a.categoryAxis, l = a.initialDate, m = a.initialCategory,
                ...
                u = a.finalXValue, y = a.initialValue, x =
                    a.finalValue, w = p.recalculateToPercents, B = b.dataDateFormat;
...
(function () {
    ...
    d.drop = function (a, b, c, d, h, f, g, k) {
        var l = 1 / 180 * Math.PI, m = c - 20, n = Math.sin(m * l) * b, q = Math.cos(m * l) * b,
            p = Math.sin((m + 40) * l) * b, t = Math.cos((m + 40) * l) * b, r = .8 * b, u = -b / 3, y = b / 3;
        0 === c && (u = -u, y = 0);
        180 == c && (y = 0);
        90 == c && (u = 0);
        270 == c && (u = 0, y = -y);
    ...
    d.wedge = function (a, b, c, e, h, f, g, k, l, m, n, q, p, t) {
        ...
        g = r(g);
        k = r(k);
        var u = r(g / f * k), y = d.VML, x = 359.5 + f / 100;
        359.94 < x && (x = 359.94);
        h >= x && (h = x);
        var w = 1 / 180 * Math.PI, x = b + Math.sin(e * w) * k, B = c - Math.cos(e * w) * u,
            z = b + Math.sin(e * w) * f, A = c - Math.cos(e * w) * g, C = b + Math.sin((e + h) * w) * f,
            D = c - Math.cos((e + h) * w) * g, J = b + Math.sin((e + h) * w) * k, w = c - Math.cos((e + h) * w) * u,
            H = {fill: d.adjustLuminosity(m.fill, -.2), "stroke-opacity": 0, "fill-opacity": m["fill-opacity"]}, R = 0;
        180 < Math.abs(h) && (R = 1);
        e = a.set();
        var L;
    ...
    d.AmLegend = d.Class({
        construct: function (a) {
            ...
            var a = this.position, b = this.marginLeft + this.titleWidth, c = this.marginRight, e = this.marginTop,
                ...
                q = k - c - b, p = 0, t = 0, r = this.container;
            ...
            if (!1 !== a.visibleInLegend && !a.hideFromLegend) {
                ...
                if (this.useGraphSettings) {
                    ...
                    (e = a.bulletColorR), n = d.bullet(l, a.bullet, a.bulletSize, e, a.bulletAlpha, a.bulletBorderThickness, f, a.bulletBorderAlpha)) && (d.setCN(b, n, "graph-bullet"), n.translate(m + 1, m / 2), g.push(n)), p = 0, n = m, q = m / 3; else {
                        var t;
